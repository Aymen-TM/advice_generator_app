...
return (
<div
    className='max-w-md relative bg-[#313A49] rounded-lg shadow-lg flex flex-col items-center justify-center  p-4 transition duration-200'>
    ...
    <button onClick={()=>{roldeDice(!role)}} className=' transition duration-200 hover:shadow-[0px_0px_20px_0px] hover:shadow-[#52ffa8] hover:shadow-2xl absolute bottom-0 translate-y-1/2 bg-[#52ffa8] rounded-full
